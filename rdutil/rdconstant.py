...
PREMIUM_FORMAT = " "*5+"{:^50s}".format("{:^10s}{:^15s}{:^10s}{:^15s}")
PREMIUM_HEADER = PREMIUM_FORMAT.format('Series', 'Date', 'Amount', 'Breaking')
MENU_ITEM_FORMAT = " "*5+"{:30s}"
COMPACT_MENU_ITEM = " "*5+"{:30s}"+" "*5+"{:30s}"
RD_HEADER_FORMAT = " "*5+"{:^10s}{:^15s}{:^15s}{:^10s}{:^10s}{:^10s}"
RD_FORMAT_WITH_ID = " "*5+"{:^10s}{:^110s}"
